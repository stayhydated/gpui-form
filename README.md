...
active Storybook locale. Value-bound shape-backed fields use helper functions and runtime aliases from
`gpui_form_runtime::shape` for state and event projections, keeping handler
