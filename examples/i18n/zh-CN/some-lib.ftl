...
british_columbia_city_label = 英属哥伦比亚城市
...
canada_province_description_variants_label = 加拿大省份描述
...
canada_province_label_variants_label = 加拿大省份标签
...
cfg_attr_example_description_variants_label = 配置属性示例描述
...
cfg_attr_example_label_variants_label = 配置属性示例标签
...
usa_state_description_variants_label = 美国州描述
...
usa_state_label_variants_label = 美国州标签
