...
generator that reads shape inventory, clears stale generated form modules, and
writes scaffolded GPUI form files. The Storybook form titles generated by that
example use the GPUI app context so they follow the active Storybook locale.
Value-bound custom fields use helper functions and runtime aliases from
