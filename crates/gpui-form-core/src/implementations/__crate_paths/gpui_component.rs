...
pub const Disableable: crate_paths::Path = crate_paths::Path::new("gpui_component::Disableable");
...
/// pub enum `IconName`
pub const IconName: crate_paths::Path = crate_paths::Path::new("gpui_component::IconName");
...
pub const InteractiveElementExt: crate_paths::Path =
    crate_paths::Path::new("gpui_component::InteractiveElementExt");

/// pub struct `Kbd`
pub const Kbd: crate_paths::Path = crate_paths::Path::new("gpui_component::Kbd");

/// pub struct `Measure`
pub const Measure: crate_paths::Path = crate_paths::Path::new("gpui_component::Measure");

/// pub enum `Placement`
pub const Placement: crate_paths::Path = crate_paths::Path::new("gpui_component::Placement");

/// pub struct `Root`
pub const Root: crate_paths::Path = crate_paths::Path::new("gpui_component::Root");

/// pub trait `Selectable`
pub const Selectable: crate_paths::Path = crate_paths::Path::new("gpui_component::Selectable");

/// pub enum `Side`
pub const Side: crate_paths::Path = crate_paths::Path::new("gpui_component::Side");

/// pub trait `Sizable`
pub const Sizable: crate_paths::Path = crate_paths::Path::new("gpui_component::Sizable");

/// pub enum `Size`
pub const Size: crate_paths::Path = crate_paths::Path::new("gpui_component::Size");

/// pub trait `StyleSized`
pub const StyleSized: crate_paths::Path = crate_paths::Path::new("gpui_component::StyleSized");
...
pub const ToggleInspector: crate_paths::Path =
    crate_paths::Path::new("gpui_component::ToggleInspector");
...
pub mod accordion {
    ...
    pub const Accordion: crate_paths::Path =
        crate_paths::Path::new("gpui_component::accordion::Accordion");

    /// pub struct `AccordionItem`
    pub const AccordionItem: crate_paths::Path =
        crate_paths::Path::new("gpui_component::accordion::AccordionItem");
}
pub mod alert {
    /// pub struct `Alert`
    pub const Alert: crate_paths::Path = crate_paths::Path::new("gpui_component::alert::Alert");

    /// pub enum `AlertVariant`
    pub const AlertVariant: crate_paths::Path =
        crate_paths::Path::new("gpui_component::alert::AlertVariant");
}
pub mod animation {
...
pub mod badge {
    /// pub struct `Badge`
    pub const Badge: crate_paths::Path = crate_paths::Path::new("gpui_component::badge::Badge");
}
pub mod breadcrumb {
    /// pub struct `Breadcrumb`
    pub const Breadcrumb: crate_paths::Path =
        crate_paths::Path::new("gpui_component::breadcrumb::Breadcrumb");

    /// pub struct `BreadcrumbItem`
    pub const BreadcrumbItem: crate_paths::Path =
        crate_paths::Path::new("gpui_component::breadcrumb::BreadcrumbItem");
}
pub mod button {
    /// pub struct `Button`
    pub const Button: crate_paths::Path = crate_paths::Path::new("gpui_component::button::Button");

    /// pub struct `ButtonCustomVariant`
    pub const ButtonCustomVariant: crate_paths::Path =
        crate_paths::Path::new("gpui_component::button::ButtonCustomVariant");

    /// pub struct `ButtonGroup`
    pub const ButtonGroup: crate_paths::Path =
        crate_paths::Path::new("gpui_component::button::ButtonGroup");

    /// pub enum `ButtonRounded`
    pub const ButtonRounded: crate_paths::Path =
        crate_paths::Path::new("gpui_component::button::ButtonRounded");

    /// pub enum `ButtonVariant`
    pub const ButtonVariant: crate_paths::Path =
        crate_paths::Path::new("gpui_component::button::ButtonVariant");

    /// pub trait `ButtonVariants`
    pub const ButtonVariants: crate_paths::Path =
        crate_paths::Path::new("gpui_component::button::ButtonVariants");

    /// pub struct `DropdownButton`
    pub const DropdownButton: crate_paths::Path =
        crate_paths::Path::new("gpui_component::button::DropdownButton");

    /// pub struct `InteractiveToggle`
    pub const InteractiveToggle: crate_paths::Path =
        crate_paths::Path::new("gpui_component::button::InteractiveToggle");

    /// pub struct `Toggle`
    pub const Toggle: crate_paths::Path = crate_paths::Path::new("gpui_component::button::Toggle");

    /// pub struct `ToggleGroup`
    pub const ToggleGroup: crate_paths::Path =
        crate_paths::Path::new("gpui_component::button::ToggleGroup");

    /// pub enum `ToggleVariant`
    pub const ToggleVariant: crate_paths::Path =
        crate_paths::Path::new("gpui_component::button::ToggleVariant");

    /// pub trait `ToggleVariants`
    pub const ToggleVariants: crate_paths::Path =
        crate_paths::Path::new("gpui_component::button::ToggleVariants");
}
pub mod calendar {
    /// pub struct `Calendar`
    pub const Calendar: crate_paths::Path =
        crate_paths::Path::new("gpui_component::calendar::Calendar");

    /// pub enum `CalendarEvent`
    pub const CalendarEvent: crate_paths::Path =
        crate_paths::Path::new("gpui_component::calendar::CalendarEvent");

    /// pub struct `CalendarState`
    pub const CalendarState: crate_paths::Path =
        crate_paths::Path::new("gpui_component::calendar::CalendarState");

    /// pub enum `Date`
    pub const Date: crate_paths::Path = crate_paths::Path::new("gpui_component::calendar::Date");

    /// pub struct `IntervalMatcher`
    pub const IntervalMatcher: crate_paths::Path =
        crate_paths::Path::new("gpui_component::calendar::IntervalMatcher");

    /// pub enum `Matcher`
    pub const Matcher: crate_paths::Path =
        crate_paths::Path::new("gpui_component::calendar::Matcher");

    /// pub struct `RangeMatcher`
    pub const RangeMatcher: crate_paths::Path =
        crate_paths::Path::new("gpui_component::calendar::RangeMatcher");
}
pub mod chart {
    /// pub struct `AreaChart`
    pub const AreaChart: crate_paths::Path =
        crate_paths::Path::new("gpui_component::chart::AreaChart");
    ...
    pub const PieChart: crate_paths::Path =
        crate_paths::Path::new("gpui_component::chart::PieChart");
}
pub mod checkbox {
    /// pub struct `Checkbox`
    pub const Checkbox: crate_paths::Path =
        crate_paths::Path::new("gpui_component::checkbox::Checkbox");
}
pub mod clipboard {
    /// pub struct `Clipboard`
    pub const Clipboard: crate_paths::Path =
        crate_paths::Path::new("gpui_component::clipboard::Clipboard");

    /// pub struct `ClipboardState`
    pub const ClipboardState: crate_paths::Path =
        crate_paths::Path::new("gpui_component::clipboard::ClipboardState");
}
pub mod color_picker {
    /// pub struct `ColorPicker`
    pub const ColorPicker: crate_paths::Path =
        crate_paths::Path::new("gpui_component::color_picker::ColorPicker");

    /// pub enum `ColorPickerEvent`
    pub const ColorPickerEvent: crate_paths::Path =
        crate_paths::Path::new("gpui_component::color_picker::ColorPickerEvent");
...
pub mod context_menu {
    ...
    pub const ContextMenu: crate_paths::Path =
        crate_paths::Path::new("gpui_component::context_menu::ContextMenu");

    /// pub trait `ContextMenuExt`
    pub const ContextMenuExt: crate_paths::Path =
        crate_paths::Path::new("gpui_component::context_menu::ContextMenuExt");

    /// pub struct `ContextMenuState`
    pub const ContextMenuState: crate_paths::Path =
        crate_paths::Path::new("gpui_component::context_menu::ContextMenuState");
}
pub mod date_picker {
    /// pub struct `DatePicker`
    pub const DatePicker: crate_paths::Path =
        crate_paths::Path::new("gpui_component::date_picker::DatePicker");

    /// pub enum `DatePickerEvent`
    pub const DatePickerEvent: crate_paths::Path =
        crate_paths::Path::new("gpui_component::date_picker::DatePickerEvent");

    /// pub struct `DatePickerState`
    pub const DatePickerState: crate_paths::Path =
        crate_paths::Path::new("gpui_component::date_picker::DatePickerState");

    /// pub struct `DateRangePreset`
    pub const DateRangePreset: crate_paths::Path =
        crate_paths::Path::new("gpui_component::date_picker::DateRangePreset");
...
pub mod description_list {
    ...
    pub const DescriptionItem: crate_paths::Path =
        crate_paths::Path::new("gpui_component::description_list::DescriptionItem");

    /// pub struct `DescriptionList`
    pub const DescriptionList: crate_paths::Path =
        crate_paths::Path::new("gpui_component::description_list::DescriptionList");

    /// pub enum `DescriptionText`
    pub const DescriptionText: crate_paths::Path =
        crate_paths::Path::new("gpui_component::description_list::DescriptionText");
}
pub mod divider {
    /// pub struct `Divider`
...
pub mod dock {
    /// pub struct `AnyDrag`
    pub const AnyDrag: crate_paths::Path = crate_paths::Path::new("gpui_component::dock::AnyDrag");

    /// pub struct `ClosePanel`
    pub const ClosePanel: crate_paths::Path =
        crate_paths::Path::new("gpui_component::dock::ClosePanel");

    /// pub struct `Dock`
    pub const Dock: crate_paths::Path = crate_paths::Path::new("gpui_component::dock::Dock");

    /// pub struct `DockArea`
    pub const DockArea: crate_paths::Path =
        crate_paths::Path::new("gpui_component::dock::DockArea");

    /// pub struct `DockAreaState`
    pub const DockAreaState: crate_paths::Path =
        crate_paths::Path::new("gpui_component::dock::DockAreaState");

    /// pub enum `DockEvent`
    pub const DockEvent: crate_paths::Path =
        crate_paths::Path::new("gpui_component::dock::DockEvent");

    /// pub enum `DockItem`
    pub const DockItem: crate_paths::Path =
        crate_paths::Path::new("gpui_component::dock::DockItem");

    /// pub enum `DockPlacement`
    pub const DockPlacement: crate_paths::Path =
        crate_paths::Path::new("gpui_component::dock::DockPlacement");

    /// pub struct `DockState`
    pub const DockState: crate_paths::Path =
        crate_paths::Path::new("gpui_component::dock::DockState");

    /// pub struct `DragDrop`
    pub const DragDrop: crate_paths::Path =
        crate_paths::Path::new("gpui_component::dock::DragDrop");

    /// pub struct `DragMoving`
    pub const DragMoving: crate_paths::Path =
        crate_paths::Path::new("gpui_component::dock::DragMoving");

    /// pub struct `DragResizing`
    pub const DragResizing: crate_paths::Path =
        crate_paths::Path::new("gpui_component::dock::DragResizing");

    /// pub trait `Panel`
    pub const Panel: crate_paths::Path = crate_paths::Path::new("gpui_component::dock::Panel");

    /// pub enum `PanelControl`
    pub const PanelControl: crate_paths::Path =
        crate_paths::Path::new("gpui_component::dock::PanelControl");

    /// pub enum `PanelEvent`
    pub const PanelEvent: crate_paths::Path =
        crate_paths::Path::new("gpui_component::dock::PanelEvent");

    /// pub enum `PanelInfo`
    pub const PanelInfo: crate_paths::Path =
        crate_paths::Path::new("gpui_component::dock::PanelInfo");

    /// pub struct `PanelRegistry`
    pub const PanelRegistry: crate_paths::Path =
        crate_paths::Path::new("gpui_component::dock::PanelRegistry");

    /// pub struct `PanelState`
    pub const PanelState: crate_paths::Path =
        crate_paths::Path::new("gpui_component::dock::PanelState");

    /// pub enum `PanelStyle`
    pub const PanelStyle: crate_paths::Path =
        crate_paths::Path::new("gpui_component::dock::PanelStyle");

    /// pub trait `PanelView`
    pub const PanelView: crate_paths::Path =
        crate_paths::Path::new("gpui_component::dock::PanelView");

    /// pub struct `Redo`
    pub const Redo: crate_paths::Path = crate_paths::Path::new("gpui_component::dock::Redo");

    /// pub struct `StackPanel`
    pub const StackPanel: crate_paths::Path =
        crate_paths::Path::new("gpui_component::dock::StackPanel");

    /// pub struct `TabPanel`
    pub const TabPanel: crate_paths::Path =
        crate_paths::Path::new("gpui_component::dock::TabPanel");

    /// pub struct `TileItem`
    pub const TileItem: crate_paths::Path =
        crate_paths::Path::new("gpui_component::dock::TileItem");

    /// pub struct `TileMeta`
    pub const TileMeta: crate_paths::Path =
        crate_paths::Path::new("gpui_component::dock::TileMeta");

    /// pub struct `Tiles`
    pub const Tiles: crate_paths::Path = crate_paths::Path::new("gpui_component::dock::Tiles");

    /// pub struct `TitleStyle`
    pub const TitleStyle: crate_paths::Path =
        crate_paths::Path::new("gpui_component::dock::TitleStyle");

    /// pub struct `ToggleZoom`
    pub const ToggleZoom: crate_paths::Path =
        crate_paths::Path::new("gpui_component::dock::ToggleZoom");
...
pub mod dropdown {
    ...
    pub const Dropdown: crate_paths::Path =
        crate_paths::Path::new("gpui_component::dropdown::Dropdown");

    /// pub trait `DropdownDelegate`
    pub const DropdownDelegate: crate_paths::Path =
        crate_paths::Path::new("gpui_component::dropdown::DropdownDelegate");

    /// pub enum `DropdownEvent`
    pub const DropdownEvent: crate_paths::Path =
        crate_paths::Path::new("gpui_component::dropdown::DropdownEvent");
    ...
    pub const ListEvent: crate_paths::Path =
        crate_paths::Path::new("gpui_component::dropdown::ListEvent");
...
pub mod form {
    ...
    pub const FieldBuilder: crate_paths::Path =
        crate_paths::Path::new("gpui_component::form::FieldBuilder");

    /// pub struct `Form`
    pub const Form: crate_paths::Path = crate_paths::Path::new("gpui_component::form::Form");

    /// pub struct `FormField`
    pub const FormField: crate_paths::Path =
        crate_paths::Path::new("gpui_component::form::FormField");

    /// pub function `form_field`
    pub const form_field: crate_paths::Path =
        crate_paths::Path::new("gpui_component::form::form_field");

    /// pub function `h_form`
    pub const h_form: crate_paths::Path = crate_paths::Path::new("gpui_component::form::h_form");
...
pub mod highlighter {
    ...
    pub const HighlightTheme: crate_paths::Path =
        crate_paths::Path::new("gpui_component::highlighter::HighlightTheme");

    /// pub struct `HighlightThemeStyle`
    pub const HighlightThemeStyle: crate_paths::Path =
        crate_paths::Path::new("gpui_component::highlighter::HighlightThemeStyle");

    /// pub enum `Language`
    pub const Language: crate_paths::Path =
        crate_paths::Path::new("gpui_component::highlighter::Language");

    /// pub struct `LanguageConfig`
    pub const LanguageConfig: crate_paths::Path =
        crate_paths::Path::new("gpui_component::highlighter::LanguageConfig");
    ...
    pub const SyntaxColors: crate_paths::Path =
        crate_paths::Path::new("gpui_component::highlighter::SyntaxColors");

    /// pub struct `SyntaxHighlighter`
    pub const SyntaxHighlighter: crate_paths::Path =
        crate_paths::Path::new("gpui_component::highlighter::SyntaxHighlighter");
...
pub mod history {
    ...
    pub const History: crate_paths::Path =
        crate_paths::Path::new("gpui_component::history::History");

    /// pub trait `HistoryItem`
    pub const HistoryItem: crate_paths::Path =
        crate_paths::Path::new("gpui_component::history::HistoryItem");
}
pub mod indicator {
    /// pub struct `Indicator`
    pub const Indicator: crate_paths::Path =
        crate_paths::Path::new("gpui_component::indicator::Indicator");
}
pub mod input {
    ...
    pub const DeleteToBeginningOfLine: crate_paths::Path =
        crate_paths::Path::new("gpui_component::input::DeleteToBeginningOfLine");

    /// pub struct `DeleteToEndOfLine`
    pub const DeleteToEndOfLine: crate_paths::Path =
        crate_paths::Path::new("gpui_component::input::DeleteToEndOfLine");

    /// pub struct `DeleteToNextWordEnd`
    pub const DeleteToNextWordEnd: crate_paths::Path =
        crate_paths::Path::new("gpui_component::input::DeleteToNextWordEnd");
    ...
    pub const InputEvent: crate_paths::Path =
        crate_paths::Path::new("gpui_component::input::InputEvent");
    ...
    pub const MoveToEnd: crate_paths::Path =
        crate_paths::Path::new("gpui_component::input::MoveToEnd");

    /// pub struct `MoveToEndOfLine`
    pub const MoveToEndOfLine: crate_paths::Path =
        crate_paths::Path::new("gpui_component::input::MoveToEndOfLine");

    /// pub struct `MoveToNextWord`
    pub const MoveToNextWord: crate_paths::Path =
        crate_paths::Path::new("gpui_component::input::MoveToNextWord");

    /// pub struct `MoveToPreviousWord`
    pub const MoveToPreviousWord: crate_paths::Path =
        crate_paths::Path::new("gpui_component::input::MoveToPreviousWord");

    /// pub struct `MoveToStart`
    pub const MoveToStart: crate_paths::Path =
        crate_paths::Path::new("gpui_component::input::MoveToStart");
    ...
    pub const NumberInputEvent: crate_paths::Path =
        crate_paths::Path::new("gpui_component::input::NumberInputEvent");

    /// pub struct `OtpInput`
    pub const OtpInput: crate_paths::Path =
        crate_paths::Path::new("gpui_component::input::OtpInput");

    /// pub struct `OtpState`
    pub const OtpState: crate_paths::Path =
        crate_paths::Path::new("gpui_component::input::OtpState");
    ...
    pub const StepAction: crate_paths::Path =
        crate_paths::Path::new("gpui_component::input::StepAction");
...
pub mod link {
    /// pub struct `Link`
    pub const Link: crate_paths::Path = crate_paths::Path::new("gpui_component::link::Link");
}
pub mod list {
    /// pub struct `List`
    pub const List: crate_paths::Path = crate_paths::Path::new("gpui_component::list::List");

    /// pub trait `ListDelegate`
    pub const ListDelegate: crate_paths::Path =
        crate_paths::Path::new("gpui_component::list::ListDelegate");

    /// pub enum `ListEvent`
    pub const ListEvent: crate_paths::Path =
        crate_paths::Path::new("gpui_component::list::ListEvent");
...
pub mod modal {
    /// pub struct `Modal`
    pub const Modal: crate_paths::Path = crate_paths::Path::new("gpui_component::modal::Modal");
...
pub mod notification {
    ...
    pub const Notification: crate_paths::Path =
        crate_paths::Path::new("gpui_component::notification::Notification");
...
pub mod plot {
    ...
    pub const AXIS_GAP: crate_paths::Path =
        crate_paths::Path::new("gpui_component::plot::AXIS_GAP");

    /// pub struct `Axis`
    pub const Axis: crate_paths::Path = crate_paths::Path::new("gpui_component::plot::Axis");

    /// pub struct `AxisText`
    pub const AxisText: crate_paths::Path =
        crate_paths::Path::new("gpui_component::plot::AxisText");

    /// pub struct `Grid`
    pub const Grid: crate_paths::Path = crate_paths::Path::new("gpui_component::plot::Grid");

    /// pub proc derive `IntoPlot`
    pub const IntoPlot: crate_paths::Path =
        crate_paths::Path::new("gpui_component::plot::IntoPlot");

    /// pub trait `Plot`
    pub const Plot: crate_paths::Path = crate_paths::Path::new("gpui_component::plot::Plot");

    /// pub enum `StrokeStyle`
    pub const StrokeStyle: crate_paths::Path =
        crate_paths::Path::new("gpui_component::plot::StrokeStyle");

    /// pub function `origin_point`
    pub const origin_point: crate_paths::Path =
        crate_paths::Path::new("gpui_component::plot::origin_point");

    /// pub function `polygon`
    pub const polygon: crate_paths::Path = crate_paths::Path::new("gpui_component::plot::polygon");
    pub mod label {
        /// pub struct `Label`
        pub const Label: crate_paths::Path =
            crate_paths::Path::new("gpui_component::plot::label::Label");

        /// pub constant `TEXT_GAP`
        pub const TEXT_GAP: crate_paths::Path =
            crate_paths::Path::new("gpui_component::plot::label::TEXT_GAP");

        /// pub constant `TEXT_HEIGHT`
        pub const TEXT_HEIGHT: crate_paths::Path =
            crate_paths::Path::new("gpui_component::plot::label::TEXT_HEIGHT");

        /// pub constant `TEXT_SIZE`
        pub const TEXT_SIZE: crate_paths::Path =
            crate_paths::Path::new("gpui_component::plot::label::TEXT_SIZE");

        /// pub struct `Text`
        pub const Text: crate_paths::Path =
            crate_paths::Path::new("gpui_component::plot::label::Text");
    }
    pub mod scale {
        /// pub trait `Scale`
        pub const Scale: crate_paths::Path =
            crate_paths::Path::new("gpui_component::plot::scale::Scale");

        /// pub struct `ScaleBand`
        pub const ScaleBand: crate_paths::Path =
            crate_paths::Path::new("gpui_component::plot::scale::ScaleBand");
    ...
    pub mod shape {
        ...
        pub const Arc: crate_paths::Path =
            crate_paths::Path::new("gpui_component::plot::shape::Arc");

        /// pub struct `Area`
        pub const Area: crate_paths::Path =
            crate_paths::Path::new("gpui_component::plot::shape::Area");

        /// pub struct `Bar`
        pub const Bar: crate_paths::Path =
            crate_paths::Path::new("gpui_component::plot::shape::Bar");

        /// pub struct `Line`
        pub const Line: crate_paths::Path =
            crate_paths::Path::new("gpui_component::plot::shape::Line");
    ...
    pub mod tooltip {
        ...
        pub const Tooltip: crate_paths::Path =
            crate_paths::Path::new("gpui_component::plot::tooltip::Tooltip");

        /// pub enum `TooltipPosition`
        pub const TooltipPosition: crate_paths::Path =
            crate_paths::Path::new("gpui_component::plot::tooltip::TooltipPosition");

        /// pub struct `TooltipState`
        pub const TooltipState: crate_paths::Path =
            crate_paths::Path::new("gpui_component::plot::tooltip::TooltipState");
    }
}
pub mod popover {
    /// pub struct `Popover`
    pub const Popover: crate_paths::Path =
        crate_paths::Path::new("gpui_component::popover::Popover");

    /// pub struct `PopoverContent`
    pub const PopoverContent: crate_paths::Path =
        crate_paths::Path::new("gpui_component::popover::PopoverContent");

    /// pub struct `PopoverElementState`
    pub const PopoverElementState: crate_paths::Path =
        crate_paths::Path::new("gpui_component::popover::PopoverElementState");
...
pub mod popup_menu {
    ...
    pub const PopupMenu: crate_paths::Path =
        crate_paths::Path::new("gpui_component::popup_menu::PopupMenu");

    /// pub trait `PopupMenuExt`
    pub const PopupMenuExt: crate_paths::Path =
        crate_paths::Path::new("gpui_component::popup_menu::PopupMenuExt");

    /// pub function `init`
    pub const init: crate_paths::Path = crate_paths::Path::new("gpui_component::popup_menu::init");
}
pub mod progress {
    /// pub struct `Progress`
    pub const Progress: crate_paths::Path =
        crate_paths::Path::new("gpui_component::progress::Progress");
}
pub mod radio {
    /// pub struct `Radio`
    pub const Radio: crate_paths::Path = crate_paths::Path::new("gpui_component::radio::Radio");

    /// pub struct `RadioGroup`
    pub const RadioGroup: crate_paths::Path =
        crate_paths::Path::new("gpui_component::radio::RadioGroup");
}
pub mod resizable {
    /// pub struct `DragPanel`
    pub const DragPanel: crate_paths::Path =
        crate_paths::Path::new("gpui_component::resizable::DragPanel");

    /// pub struct `ResizablePanel`
    pub const ResizablePanel: crate_paths::Path =
        crate_paths::Path::new("gpui_component::resizable::ResizablePanel");

    /// pub enum `ResizablePanelEvent`
    pub const ResizablePanelEvent: crate_paths::Path =
        crate_paths::Path::new("gpui_component::resizable::ResizablePanelEvent");

    /// pub struct `ResizablePanelGroup`
    pub const ResizablePanelGroup: crate_paths::Path =
        crate_paths::Path::new("gpui_component::resizable::ResizablePanelGroup");

    /// pub struct `ResizableState`
    pub const ResizableState: crate_paths::Path =
        crate_paths::Path::new("gpui_component::resizable::ResizableState");

    /// pub function `h_resizable`
    pub const h_resizable: crate_paths::Path =
        crate_paths::Path::new("gpui_component::resizable::h_resizable");

    /// pub function `resizable_panel`
    pub const resizable_panel: crate_paths::Path =
        crate_paths::Path::new("gpui_component::resizable::resizable_panel");
...
pub mod scroll {
    ...
    pub const AxisPrepaintState: crate_paths::Path =
        crate_paths::Path::new("gpui_component::scroll::AxisPrepaintState");

    /// pub struct `PrepaintState`
    pub const PrepaintState: crate_paths::Path =
        crate_paths::Path::new("gpui_component::scroll::PrepaintState");
    ...
    pub const ScrollViewState: crate_paths::Path =
        crate_paths::Path::new("gpui_component::scroll::ScrollViewState");
    ...
    pub const ScrollableMask: crate_paths::Path =
        crate_paths::Path::new("gpui_component::scroll::ScrollableMask");

    /// pub struct `Scrollbar`
    pub const Scrollbar: crate_paths::Path =
        crate_paths::Path::new("gpui_component::scroll::Scrollbar");
    ...
    pub const ScrollbarShow: crate_paths::Path =
        crate_paths::Path::new("gpui_component::scroll::ScrollbarShow");
...
pub mod sidebar {
    ...
    pub const Sidebar: crate_paths::Path =
        crate_paths::Path::new("gpui_component::sidebar::Sidebar");

    /// pub struct `SidebarFooter`
    pub const SidebarFooter: crate_paths::Path =
        crate_paths::Path::new("gpui_component::sidebar::SidebarFooter");

    /// pub struct `SidebarGroup`
    pub const SidebarGroup: crate_paths::Path =
        crate_paths::Path::new("gpui_component::sidebar::SidebarGroup");

    /// pub struct `SidebarHeader`
    pub const SidebarHeader: crate_paths::Path =
        crate_paths::Path::new("gpui_component::sidebar::SidebarHeader");

    /// pub struct `SidebarMenu`
    pub const SidebarMenu: crate_paths::Path =
        crate_paths::Path::new("gpui_component::sidebar::SidebarMenu");

    /// pub struct `SidebarMenuItem`
    pub const SidebarMenuItem: crate_paths::Path =
        crate_paths::Path::new("gpui_component::sidebar::SidebarMenuItem");

    /// pub struct `SidebarToggleButton`
    pub const SidebarToggleButton: crate_paths::Path =
        crate_paths::Path::new("gpui_component::sidebar::SidebarToggleButton");
}
pub mod skeleton {
    /// pub struct `Skeleton`
    pub const Skeleton: crate_paths::Path =
        crate_paths::Path::new("gpui_component::skeleton::Skeleton");
}
pub mod slider {
    /// pub struct `DragThumb`
    pub const DragThumb: crate_paths::Path =
        crate_paths::Path::new("gpui_component::slider::DragThumb");

    /// pub struct `Slider`
    pub const Slider: crate_paths::Path = crate_paths::Path::new("gpui_component::slider::Slider");

    /// pub enum `SliderEvent`
    pub const SliderEvent: crate_paths::Path =
        crate_paths::Path::new("gpui_component::slider::SliderEvent");
...
pub mod tab {
    ...
    pub const SelectTab: crate_paths::Path =
        crate_paths::Path::new("gpui_component::tab::SelectTab");

    /// pub struct `Tab`
    pub const Tab: crate_paths::Path = crate_paths::Path::new("gpui_component::tab::Tab");

    /// pub struct `TabBar`
    pub const TabBar: crate_paths::Path = crate_paths::Path::new("gpui_component::tab::TabBar");
...
pub mod table {
    ...
    pub const SelectNextColumn: crate_paths::Path =
        crate_paths::Path::new("gpui_component::table::SelectNextColumn");

    /// pub struct `SelectPrevColumn`
    pub const SelectPrevColumn: crate_paths::Path =
        crate_paths::Path::new("gpui_component::table::SelectPrevColumn");

    /// pub struct `Table`
    pub const Table: crate_paths::Path = crate_paths::Path::new("gpui_component::table::Table");

    /// pub trait `TableDelegate`
    pub const TableDelegate: crate_paths::Path =
        crate_paths::Path::new("gpui_component::table::TableDelegate");

    /// pub enum `TableEvent`
    pub const TableEvent: crate_paths::Path =
        crate_paths::Path::new("gpui_component::table::TableEvent");
...
pub mod tag {
    /// pub struct `Tag`
    pub const Tag: crate_paths::Path = crate_paths::Path::new("gpui_component::tag::Tag");

    /// pub enum `TagVariant`
    pub const TagVariant: crate_paths::Path =
        crate_paths::Path::new("gpui_component::tag::TagVariant");
}
pub mod text {
    /// pub enum `Text`
